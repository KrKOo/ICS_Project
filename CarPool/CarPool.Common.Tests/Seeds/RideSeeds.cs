...
public static class RideSeeds
{
	...
	public static readonly RideEntity RideEntityUpdate = RideEntity1 with
	{
		Id = Guid.Parse("6435BFB8-E391-48A0-9473-8A97BB558D82"),
		Passengers = Array.Empty<UserRideEntity>(),
		Driver = null,
		Car = null,
		CarID = CarSeeds.CarRideEntityUpdate.Id,
		DriverId = UserSeeds.UserRidesAsDriverEntityUpdate.Id
	};
	public static readonly RideEntity RideEntityDelete = RideEntity1 with
	{
		Id = Guid.Parse("45D3C767-40D4-435B-B06F-89B850ECDC8D"),
		Passengers = Array.Empty<UserRideEntity>(),
		Driver = null,
		Car = null,
		CarID = CarSeeds.CarRideEntityDelete.Id,
		DriverId = UserSeeds.UserRidesAsDriverEntityDelete.Id
	};

	public static readonly RideEntity RideEntityPassengersUpdate = RideEntity1 with
	{
		Id = Guid.Parse("B2EA4CD5-699D-4F83-B27F-226F27477008"),
		Passengers = Array.Empty<UserRideEntity>(),
		Driver = null,
		Car = null,
		CarID = CarSeeds.CarRideEntityUpdate.Id,
	...
	public static readonly RideEntity RideEntityPassengersDelete = RideEntity1 with
	{
		Id = Guid.Parse("6F514278-91FD-4D3F-825B-DA335E14E9B8"),
		Passengers = Array.Empty<UserRideEntity>(),
		Driver = null,
		Car = null,
		CarID = CarSeeds.CarRideEntityDelete.Id,
