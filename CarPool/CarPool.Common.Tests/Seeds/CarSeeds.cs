...
public static class CarSeeds
{
    ...
    public static readonly CarEntity CarRideEntityUpdate = CarEntity with { Id = Guid.Parse("A2E6849D-A158-4436-980C-7FC26B60C674"), Owner = null, Rides = Array.Empty<RideEntity>(), OwnerId = UserSeeds.UserCarsEntityUpdate.Id};
    public static readonly CarEntity CarRideEntityDelete = CarEntity with { Id = Guid.Parse("30872EFF-CED4-4F2B-89DB-0EE83A74D279"), Owner = null, Rides = Array.Empty<RideEntity>(), OwnerId = UserSeeds.UserCarsEntityDelete.Id};


    static CarSeeds()
    {
        CarEntity1.Rides.Add(RideSeeds.RideEntity1);
        CarEntity1.Rides.Add(RideSeeds.RideEntity2);
    }
